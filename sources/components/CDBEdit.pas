...
procedure Register;
begin
  RegisterComponents('Custom', [TCDBEdit]);
end;
...
begin
  ...
  with Owner as TCustomCDBEdit do
...
constructor TCustomCDBEdit.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
...
procedure TCustomCDBEdit.CMBidimodechanged(var Message: TMessage);
begin
  inherited;
...
procedure TCustomCDBEdit.CMEnabledchanged(var Message: TMessage);
begin
  inherited;
  if FEditLabel <> nil then
...
procedure TCustomCDBEdit.CMVisiblechanged(var Message: TMessage);
begin
  inherited;
  if FEditLabel <> nil then
...
procedure TCustomCDBEdit.Notification(AComponent: TComponent;
...
procedure TCustomCDBEdit.SetBounds(ALeft, ATop, AWidth, AHeight: Integer);
begin
  inherited SetBounds(ALeft, ATop, AWidth, AHeight);
  SetLabelPosition(FLabelPosition);
end;

procedure TCustomCDBEdit.SetLabelPosition(const Value: TLabelPosition);
var
  P: TPoint;
begin
...
procedure TCustomCDBEdit.SetLabelSpacing(const Value: Integer);
begin
  FLabelSpacing := Value;
  SetLabelPosition(FLabelPosition);
end;

procedure TCustomCDBEdit.SetName(const Value: TComponentName);
var
  LClearText: Boolean;
begin
...
procedure TCustomCDBEdit.SetParent(AParent: TWinControl);
begin
...
procedure TCustomCDBEdit.SetupInternalLabel;
begin
